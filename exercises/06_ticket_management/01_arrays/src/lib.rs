...
impl WeekTemperatures {
    ...
    pub fn set_temperature(&mut self, day: Weekday, temperature: i32) {
        match day {
            Weekday::Monday => self.temperatures[0] = Some(temperature as i32),
            Weekday::Tuesday => self.temperatures[1] = Some(temperature as i32),
            Weekday::Wednesday => self.temperatures[2] = Some(temperature as i32),
            Weekday::Thursday => self.temperatures[3] = Some(temperature as i32),
            Weekday::Friday => self.temperatures[4] = Some(temperature as i32),
            Weekday::Saturday => self.temperatures[5] = Some(temperature as i32),
            Weekday::Sunday => self.temperatures[6] = Some(temperature as i32),
        }
    }
}
